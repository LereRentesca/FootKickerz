...
from products.views import add_product, view_product, catalog, delete_product, product_detail, view_product_catalog
...
urlpatterns = [
    ...
    path('products/catalog/<int:product_id>/', view_product_catalog, name='product' ),
]